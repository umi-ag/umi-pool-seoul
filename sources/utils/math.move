module umi_pool::math {
    ...
    public fun expand_to_decimals(num: u64, decimals: u8): u64 {
        num * (pow(10, decimals) as u64)
    }
    ...
    #[test]
    public fun test_expand_to_decimals() {
        assert!(expand_to_decimals(4, 3) == 4000, 0);
    }
}